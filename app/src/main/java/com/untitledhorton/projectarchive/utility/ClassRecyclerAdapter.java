...
import com.untitledhorton.projectarchive.AnnouncementActivity;
import com.untitledhorton.projectarchive.CourseWorkActivity;
...
public class ClassRecyclerAdapter extends RecyclerView.Adapter<ClassRecyclerAdapter.CVHolder>{
    ...
    @Override
    public void onBindViewHolder(CVHolder customViewHolder, final int i) {
