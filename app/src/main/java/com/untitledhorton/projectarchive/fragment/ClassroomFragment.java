...
import com.untitledhorton.projectarchive.model.ClassCourse;
import com.untitledhorton.projectarchive.utility.ClassRecyclerAdapter;
...
public class ClassroomFragment extends Fragment implements EasyPermissions.PermissionCallbacks {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_classroom, null);
    }

    @Override
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        super.onViewCreated(view, savedInstanceState);
        getActivity().setTitle("Classroom");

        recyclerView = view.findViewById(R.id.subjectRV);
    ...
    private void getResultsFromApi() {
        if (! isGooglePlayServicesAvailable()) {
            ...
            new ClassroomFragment.MakeRequestTask(mCredential).execute();
        }
    }
